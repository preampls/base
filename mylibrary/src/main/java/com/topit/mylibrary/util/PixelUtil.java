...
public final class PixelUtil {
    ...
    public static String getMac(Context context) {
        ...
        strMac = getMACAddress("wlan0");
        //PixelUtil.getIPAddress(true); // IPv4
        //PixelUtil.getIPAddress(false); // IPv6
        //PixelUtil.getMACAddress("wlan0"));//MAC wlan0
        //PixelUtil.getMACAddress("eth0");//MAC eth0
        //https://www.jianshu.com/p/3f7d368663aa
        if (TextUtils.isEmpty(strMac)) {
            strMac = getMACAddress("eth0");
        }

        EvtLog.e("strMac:=" + strMac);
        if (strMac == null) {
            return "02:00:00:00:00:00";
        } else {
            return strMac.toUpperCase().replace(":", "-");
        }
     ...
     * @return
     */
    public static String loadFileAsString1(String filename) throws java.io.IOException {
    ...
    public static String getMACAddress(String interfaceName) {
        try {
            ...
            for (NetworkInterface intf : interfaces) {
                ...
                return buf.toString().toUpperCase().replace(":", "-");
            }
        } catch (Exception ex) {
    ...
    public static String getUploadMac(String mac1, String mac2) {
        String mac = "";
        if (!TextUtils.isEmpty(mac1) && !TextUtils.isEmpty(mac2) && mac1.equals(mac2)) {
            mac = mac1;
        }else if (TextUtils.isEmpty(mac1) && !TextUtils.isEmpty(mac2)){
            mac = mac2;
        }else if (!TextUtils.isEmpty(mac1) && TextUtils.isEmpty(mac2)){
            mac = mac1;
        }else {
            if (!TextUtils.isEmpty(mac1) && !TextUtils.isEmpty(mac2)) {
                mac = mac1 + "*" + mac2;
            } else if (!TextUtils.isEmpty(mac1)) {
                mac = mac1;
