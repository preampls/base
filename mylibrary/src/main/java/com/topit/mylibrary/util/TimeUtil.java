...
public class TimeUtil {
    ...
    public static String getFirstDayOfThisMonth() {
        SimpleDateFormat myFormatter = new SimpleDateFormat(FORMAT_THREE);
...
//        int second = time.getSecond();
        ...
        String stringTime = getStringTime(getNowDateString());
        return stringTime + "" + nano;
    }
